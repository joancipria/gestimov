...
return array(
    ...
    'DOCS_AVATARS' => realpath(dirname(__FILE__).'/../../') . '/docs/',
    /**
    ...
    'EMAIL_SMTP_USERNAME' => 'gestimovplus',
    'EMAIL_SMTP_PASSWORD' => 'G3sT1M0v2oI7',
    'EMAIL_SMTP_PORT' => 465,
    ...
    'EMAIL_PASSWORD_RESET_FROM_NAME' => 'Gestimov+',
    'EMAIL_PASSWORD_RESET_SUBJECT' => 'Password reset for Gestimov+',
